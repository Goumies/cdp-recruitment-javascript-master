...
describe('Count', () => {
    test('should return updated name with children count', () => {
        const COUNTRIES_WITH_PEOPLE_AND_ANIMALS_COUNTS = [
            {
                name: 'Dillauti [5]',
                people: [
                    {
        ...
        count('ry')
            .on('data', (data) =>{
                expect(data).toStrictEqual(COUNTRIES_WITH_PEOPLE_AND_ANIMALS_COUNTS)
            })
    })
})